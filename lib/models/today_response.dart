...
//
//     final todayResponse = todayResponseFromMap(jsonString);
...
class TodayResponse {
  ...
  factory TodayResponse.fromJson(String str) =>
      TodayResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory TodayResponse.fromMap(Map<String, dynamic> json) => TodayResponse(
